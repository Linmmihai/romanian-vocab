...
每日任务队列按 Anki 式阶段出卡：已到点的学习/重新学习步骤优先，其次是正式到期复习，最后才是真正未学过的新词。新词答错只会留在“学习中”并按短间隔重试；只有已经毕业进入复习阶段的词再次答错，才算 lapse 并进入“需加强”。一个词一旦产生卡片答题记录，就不会再显示为“今日待学”。

## 状态逻辑手动检查

修改打卡、每日任务或复习逻辑后，至少检查这些路径：

- 新词点“不认识”：今日完成数不增加，刷新后仍不计入完成，保持“学习中”，并按短间隔等待学习步骤；不能进入“需加强”。
...
- 复习队列：答错已毕业/已掌握词后进入重新学习，标记“待复习”并附加“需加强”，按短间隔优先复习。
