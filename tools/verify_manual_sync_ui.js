...
assert(app.includes('const verification = await apiVerifyTodayState'), 'manual sync success must require cloud read-back');
...
assert(html.includes("window.ROMANIAN_VOCAB_APP_VERSION='20260726-phrase-curation'"), 'phrase-curation release must have a distinct app version');
