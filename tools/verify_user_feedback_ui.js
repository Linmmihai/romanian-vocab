...
assert(html.includes('app.js?v=20260711-daily-plan'), 'app cache buster should include the daily planner update');
assert(serviceWorker.includes('ro-vocab-pwa-v17'), 'service worker cache should include the daily planner update');
