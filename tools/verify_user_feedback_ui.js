...
assert(html.includes('app.js?v=20260711-progress-model'), 'app cache buster should include the progress model update');
assert(serviceWorker.includes('ro-vocab-pwa-v16'), 'service worker cache should include the progress model update');
