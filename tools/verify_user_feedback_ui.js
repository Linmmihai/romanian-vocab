...
assert(html.includes('app.js?v=20260711-quality-cleanup'), 'app cache buster should include the quality cleanup');
assert(serviceWorker.includes('ro-vocab-pwa-v18'), 'service worker cache should include the quality cleanup');
