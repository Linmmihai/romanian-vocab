...
assert(html.includes('app.js?v=20260805-storage-safe-sync-v6'), 'app cache buster should include the storage-safe sync fix');
assert(serviceWorker.includes('ro-vocab-pwa-v43'), 'service worker cache should include the storage-safe sync fix');
