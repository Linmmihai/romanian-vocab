...
assert(html.includes('app.js?v=20260712-reliability'), 'app cache buster should include the reliability release');
assert(serviceWorker.includes('ro-vocab-pwa-v19'), 'service worker cache should include the reliability release');
