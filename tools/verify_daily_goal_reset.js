...

{
  ...
  assert(index.includes('app.js?v=20260711-progress-model'), 'app.js cache-busting version must include the progress model changes');
  assert(serviceWorker.includes("ro-vocab-pwa-v16"), 'service worker cache name must move with app shell behavior changes');
}
