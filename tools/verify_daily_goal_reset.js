...

{
  ...
  assert(index.includes('app.js?v=20260725-card-taxonomy'), 'app.js cache-busting version must include the taxonomy release');
  assert(serviceWorker.includes("ro-vocab-pwa-v33"), 'service worker cache name must move with app shell behavior changes');
}
