...

{
  ...
  assert(index.includes('app.js?v=20260714-progress-queue-fix'), 'app.js cache-busting version must include the progress and queue fix');
  assert(serviceWorker.includes("ro-vocab-pwa-v23"), 'service worker cache name must move with app shell behavior changes');
}
