...

{
  ...
  assert(index.includes('app.js?v=20260711-daily-plan'), 'app.js cache-busting version must include the daily planner changes');
  assert(serviceWorker.includes("ro-vocab-pwa-v17"), 'service worker cache name must move with app shell behavior changes');
}
