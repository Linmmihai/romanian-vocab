...

{
  ...
  assert(index.includes('app.js?v=20260711-shared-scheduler'), 'app.js cache-busting version must include the shared scheduler changes');
  assert(serviceWorker.includes("ro-vocab-pwa-v15"), 'service worker cache name must move with app shell behavior changes');
}
