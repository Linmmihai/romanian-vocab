...
assert(index.includes('scheduler.js?v=20260711-shared-scheduler'), 'scheduler cache buster must move with shared scheduler changes');
assert(index.includes('api.js?v=20260711-shared-scheduler'), 'API cache buster must match the shared scheduler release');
assert(index.includes('app.js?v=20260711-shared-scheduler'), 'app cache buster must match the shared scheduler release');
assert(serviceWorker.includes('ro-vocab-pwa-v15'), 'service worker cache must move with shared scheduler changes');
