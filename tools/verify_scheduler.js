...
assert(index.includes('scheduler.js?v=20260812-adversarial-v2'), 'scheduler cache buster must move with the formal-review-first fix');
assert(index.includes('api.js?v=20260812-adversarial-v2'), 'API cache buster must match the formal-review-first fix');
assert(index.includes('app.js?v=20260812-adversarial-v2'), 'app cache buster must match the formal-review-first fix');
assert(serviceWorker.includes('ro-vocab-pwa-v45-adversarial-v2'), 'service worker cache must move with the formal-review-first fix');
