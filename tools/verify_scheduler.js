...
assert(index.includes('scheduler.js?v=20260831-leaderboard-sync-v1'), 'scheduler cache buster must move with the leaderboard sync fix');
assert(index.includes('api.js?v=20260831-leaderboard-sync-v1'), 'API cache buster must match the leaderboard sync fix');
assert(index.includes('app.js?v=20260831-leaderboard-sync-v1'), 'app cache buster must match the leaderboard sync fix');
assert(serviceWorker.includes('ro-vocab-pwa-v47-leaderboard-sync-v1'), 'service worker cache must move with the leaderboard sync fix');
