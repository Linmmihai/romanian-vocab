...
assert(index.includes('scheduler.js?v=20260819-scientific-quiz-v1'), 'scheduler cache buster must move with the scientific quiz release');
assert(index.includes('api.js?v=20260819-scientific-quiz-v1'), 'API cache buster must match the scientific quiz release');
assert(index.includes('app.js?v=20260819-scientific-quiz-v1'), 'app cache buster must match the scientific quiz release');
assert(serviceWorker.includes('ro-vocab-pwa-v46-scientific-quiz-v1'), 'service worker cache must move with the scientific quiz release');
