...
const files = ['scheduler.js', 'progress-model.js', 'daily-plan.js', 'taxonomy.js', 'romanian-text.js', 'api.js', 'telemetry.js', 'auth.js', 'app.js', 'pwa.js', 'manifest.webmanifest', 'sw.js'];
